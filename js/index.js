var gapikey = 'AIzaSyCKMpw2nmPnon_gkh4EIXnbiAmrZNw-v4M';
		...
		$( document ).ready(function() {
			  $('#query').val("保 安 局 禁 毒 處 Narcotics Division, Security Bureau");
			  search();
		});
...
function getOutput(item) {
    ...
    // Build output string
    var output = 	'<li>' +
        				'<a data-fancybox-type="iframe" class="fancyboxIframe" href="https://youtube.com/embed/' + videoID + '?rel=0"><div class="list-left">' +
        					'<img src="' + thumb + '">' +
        				'</div>' +
